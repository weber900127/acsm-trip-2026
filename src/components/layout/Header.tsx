    ...
    return (
        <header className="relative pt-8 pb-12 px-4 overflow-hidden">
            <div className="max-w-4xl mx-auto relative z-10">
                ...
                {/* Countdown Post-it - Moved to top-right to avoid crowding */}
                <div className="absolute -top-6 -right-2 md:-right-8 paper-note p-3 w-28 text-center transform rotate-6 z-20 hidden md:block shadow-md">
